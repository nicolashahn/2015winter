...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        # state space is tuple of current coordinates,
        # list of coordinates of corners remaining
    ...
    def getSuccessors(self, state):
        ...
        # if we are currently in a corner tile
        # remove it from the list of remaining corners

        # this is different than self.cornersLeft, this is updated throughout search
        # print state

        # print state
        cornersLeft = list(state[1])
        if state[0] in cornersLeft:
...
def cornersHeuristic(state, problem):
    ...
    #print state, " heuristic is ", heuristic
